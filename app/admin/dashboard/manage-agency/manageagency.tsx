          ...
          <table className="w-full border-collapse table-auto">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="p-1 sm:p-3 text-left font-medium text-xs sm:text-sm whitespace-nowrap">
                  Phone
                </th>
                <th className="p-1 sm:p-3 text-left font-medium text-xs sm:text-sm whitespace-nowrap">
                  Email
            ...
            <tbody>
              {currentItems.map((request) => (
                ...
                >
                  ...
                  <td className="p-1 sm:p-3 text-xs sm:text-sm font-medium">
                    <span className="line-clamp-1">{request.id}</span>
                  </td>
                  ...
                  <td className="p-1 sm:p-3 text-xs sm:text-sm">
                    <span className="line-clamp-1">{request.phoneNumber || '-'}</span>
                  </td>
                  <td className="p-1 sm:p-3 text-xs sm:text-sm">
                    <span className={`line-clamp-1 ${getEmailHighlight(request.email) || ''}`}>
                      {request.email}
                    </span>
                  </td>
                  <td className="p-1 sm:p-3 text-xs sm:text-sm">
                    <span className="line-clamp-1">{request.AgencyName}</span>
                  </td>
                  <td className="p-1 sm:p-3 text-xs sm:text-sm">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <div
                          className={`inline-flex items-center px-2.5 py-1 rounded-md cursor-pointer ${request.status === "Active"
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger className="focus:outline-none">
                          <div className={`inline-flex items-center px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-md text-xs sm:text-sm ${getRequestTypeColor(request.requestType)}`}>
                            <span className="cursor-pointer">{screenSize === "sm" ? request.requestType.substring(0, 3) : request.requestType}</span>
                          </div>
                        </DropdownMenuTrigger>

  ...
  const navigationItems: NavigationItem[] = [
    {
      ...
      icon: Edit3,
      path: `/agency-admin/dashboard/Itenary-form${enquiryId ? `?enquiryId=${enquiryId}` : ""}`,
    },
    {
      id: "itineraries",
      label: "Itineraries",
      icon: FileText,
      path: `/agency-admin/dashboard/Itenary-view${enquiryId && itineraryId ? `?enquiryId=${enquiryId}&itineraryId=${itineraryId}` : ""}`,
    },
    {
      id: "share-customer",
      label: "Share to Customer",
      icon: Share,
      path: `/agency-admin/dashboard/share-customer${enquiryId && itineraryId ? `?enquiryId=${enquiryId}&itineraryId=${itineraryId}` : ""}`,
    },
    {
      id: "share-dmc",
      label: "Share to DMC",
      icon: MessageSquare,
      path: `/agency-admin/dashboard/share-dmc${enquiryId && itineraryId ? `?enquiryId=${enquiryId}&itineraryId=${itineraryId}` : ""}`,
    },
    {
      id: "customer-transaction",
      label: "Customer payment",
      icon: CreditCard,
      path: `/agency-admin/dashboard/customer-payment${enquiryId && itineraryId ? `?enquiryId=${enquiryId}&itineraryId=${itineraryId}` : ""}`,
    },
    {
      id: "dmc-payout",
      label: "DMC payment",
      icon: Banknote,
      path: `/agency-admin/dashboard/dmc-payment${enquiryId && itineraryId ? `?enquiryId=${enquiryId}&itineraryId=${itineraryId}` : ""}`,
    },
    {
      id: "booking-details",
      label: "Booking details",
      icon: Download,
      path: `/agency-admin/dashboard/booking-details${enquiryId && itineraryId ? `?enquiryId=${enquiryId}&itineraryId=${itineraryId}` : ""}`,
    },
    {
      id: "feedbacks",
      label: "Feedbacks",
      icon: ThumbsUp,
      path: `/agency-admin/dashboard/feedback${enquiryId && itineraryId ? `?enquiryId=${enquiryId}&itineraryId=${itineraryId}` : ""}`,
    },
  ]
